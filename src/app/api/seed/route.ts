...
const SEED_COURSES = [
	{
		...
		imageUrl:
			'https://pvlvuqg54cpvg3px.public.blob.vercel-storage.com/image-1.jpg',
		heroImage:
			'https://pvlvuqg54cpvg3px.public.blob.vercel-storage.com/image-1.jpg',
		videoUrl:
			'https://pvlvuqg54cpvg3px.public.blob.vercel-storage.com/video-1.mp4',
		provider: {
	...
	},
	{
		...
		imageUrl:
			'https://pvlvuqg54cpvg3px.public.blob.vercel-storage.com/image-2.jpg',
		heroImage:
			'https://pvlvuqg54cpvg3px.public.blob.vercel-storage.com/image-2.jpg',
		videoUrl:
			'https://pvlvuqg54cpvg3px.public.blob.vercel-storage.com/video-2.mp4',
		provider: {
			name: 'StartHub Academy',
			url: 'https://starthub.academy',
		},
	...
	},
	{
		...
		imageUrl:
			'https://pvlvuqg54cpvg3px.public.blob.vercel-storage.com/image-3.jpg',
		heroImage:
			'https://pvlvuqg54cpvg3px.public.blob.vercel-storage.com/image-3.jpg',
		videoUrl:
			'https://pvlvuqg54cpvg3px.public.blob.vercel-storage.com/video-3.mp4',
		provider: {
			name: 'StartHub Academy',
			url: 'https://starthub.academy',
		},
	...
	},
	{
		...
		imageUrl:
			'https://pvlvuqg54cpvg3px.public.blob.vercel-storage.com/image-4.jpg',
		heroImage:
			'https://pvlvuqg54cpvg3px.public.blob.vercel-storage.com/image-4.jpg',
		videoUrl:
			'https://pvlvuqg54cpvg3px.public.blob.vercel-storage.com/video-4.mp4',
		provider: {
			name: 'StartHub Academy',
			url: 'https://starthub.academy',
		},
